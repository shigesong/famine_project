...
Here is another way to do it. This time I use the "htmlTable" function in the *[Gmisc](http://gforge.se/gmisc/)* package (not yet in CRAN):
...
```{r texreg, results='asis', message=FALSE, echo=T, warning=FALSE, tidy=TRUE}
library(texreg)
