...
Of course, you also need *R*, *Rstudio*, *knitr*, and *knitcitations*, which are all *free*. The source file can be found from [GitHub](https://github.com/shigesong/famine_project/blob/master/test_markdown.Rmd). 
